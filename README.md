...
- **[aide](https://github.com/jmylchreest/aide)** (★16, Go)<br>
  <sub>[release: `v0.1.16`](https://github.com/jmylchreest/aide/releases/latest) · [downloads: 21 / 1.5k](https://github.com/jmylchreest/aide/releases) · [issues: 1](https://github.com/jmylchreest/aide/issues) · [PRs: 0](https://github.com/jmylchreest/aide/pulls)</sub>
...
- **[rosec](https://github.com/jmylchreest/rosec)** (★42, Rust)<br>
  <sub>[release: `v0.0.34`](https://github.com/jmylchreest/rosec/releases/latest) · [downloads: 68 / 824](https://github.com/jmylchreest/rosec/releases) · [issues: 4](https://github.com/jmylchreest/rosec/issues) · [PRs: 0](https://github.com/jmylchreest/rosec/pulls)</sub>
...
- **[refind-btrfs-snapshots](https://github.com/jmylchreest/refind-btrfs-snapshots)** (★25, Go)<br>
  <sub>[release: `v0.1.1`](https://github.com/jmylchreest/refind-btrfs-snapshots/releases/latest) · [downloads: 485 / 1.7k](https://github.com/jmylchreest/refind-btrfs-snapshots/releases) · [issues: 0](https://github.com/jmylchreest/refind-btrfs-snapshots/issues) · [PRs: 1](https://github.com/jmylchreest/refind-btrfs-snapshots/pulls)</sub>
...
- **[tinct](https://github.com/jmylchreest/tinct)** (★21, Go)<br>
  <sub>[release: `v0.5.0`](https://github.com/jmylchreest/tinct/releases/latest) · [downloads: 5.1k / 926.2k](https://github.com/jmylchreest/tinct/releases) · [issues: 0](https://github.com/jmylchreest/tinct/issues) · [PRs: 1](https://github.com/jmylchreest/tinct/pulls)</sub>
...
- **[histui](https://github.com/jmylchreest/histui)** (★20, Go)<br>
  <sub>[release: `v0.0.14`](https://github.com/jmylchreest/histui/releases/latest) · [downloads: 358 / 1.2k](https://github.com/jmylchreest/histui/releases) · [issues: 0](https://github.com/jmylchreest/histui/issues) · [PRs: 4](https://github.com/jmylchreest/histui/pulls)</sub>
...
- **[tvarr](https://github.com/jmylchreest/tvarr)** (★14, Go)<br>
  <sub>[release: `v0.0.27`](https://github.com/jmylchreest/tvarr/releases/latest) · [downloads: 0 / 41](https://github.com/jmylchreest/tvarr/releases) · [issues: 0](https://github.com/jmylchreest/tvarr/issues) · [PRs: 4](https://github.com/jmylchreest/tvarr/pulls)</sub>
...
- **[keylightd](https://github.com/jmylchreest/keylightd)** (★14, Go)<br>
  <sub>[release: `v0.1.9`](https://github.com/jmylchreest/keylightd/releases/latest) · [downloads: 45 / 726](https://github.com/jmylchreest/keylightd/releases) · [issues: 1](https://github.com/jmylchreest/keylightd/issues) · [PRs: 2](https://github.com/jmylchreest/keylightd/pulls)</sub>
...
- **[lobslaw](https://github.com/jmylchreest/lobslaw)** (★1, Go)<br>
  <sub>[release: `models-all-MiniLM-L6-v2`](https://github.com/jmylchreest/lobslaw/releases/latest) · [downloads: 58 / 58](https://github.com/jmylchreest/lobslaw/releases) · [issues: 7](https://github.com/jmylchreest/lobslaw/issues) · [PRs: 1](https://github.com/jmylchreest/lobslaw/pulls)</sub>
