...
- **[rosec](https://github.com/jmylchreest/rosec)** (★25, Rust)<br>
  <sub>[release: `v0.0.30`](https://github.com/jmylchreest/rosec/releases/latest) · [downloads: 18 / 231](https://github.com/jmylchreest/rosec/releases) · [issues: 5](https://github.com/jmylchreest/rosec/issues) · [PRs: 0](https://github.com/jmylchreest/rosec/pulls)</sub>
...
- **[tinct](https://github.com/jmylchreest/tinct)** (★16, Go)<br>
  <sub>[release: `v0.3.3`](https://github.com/jmylchreest/tinct/releases/latest) · [downloads: 3.1k / 184.5k](https://github.com/jmylchreest/tinct/releases) · [issues: 0](https://github.com/jmylchreest/tinct/issues) · [PRs: 0](https://github.com/jmylchreest/tinct/pulls)</sub>
...
- **[histui](https://github.com/jmylchreest/histui)** (★14, Go)<br>
  <sub>[release: `v0.0.11`](https://github.com/jmylchreest/histui/releases/latest) · [downloads: 99 / 443](https://github.com/jmylchreest/histui/releases) · [issues: 0](https://github.com/jmylchreest/histui/issues) · [PRs: 4](https://github.com/jmylchreest/histui/pulls)</sub>
