...
- **[aide](https://github.com/jmylchreest/aide)** (★6, Go)<br>
  <sub>[release: `v0.0.60`](https://github.com/jmylchreest/aide/releases/latest) · [issues: 0](https://github.com/jmylchreest/aide/issues) · [PRs: 0](https://github.com/jmylchreest/aide/pulls)</sub>
...
- **[rosec](https://github.com/jmylchreest/rosec)** (★10, Rust)<br>
  <sub>[release: `v0.0.25`](https://github.com/jmylchreest/rosec/releases/latest) · [issues: 0](https://github.com/jmylchreest/rosec/issues) · [PRs: 0](https://github.com/jmylchreest/rosec/pulls)</sub>
...
- **[tinct](https://github.com/jmylchreest/tinct)** (★15, Go)<br>
  <sub>[release: `v0.2.2`](https://github.com/jmylchreest/tinct/releases/latest) · [issues: 1](https://github.com/jmylchreest/tinct/issues) · [PRs: 0](https://github.com/jmylchreest/tinct/pulls)</sub>
...
- **[histui](https://github.com/jmylchreest/histui)** (★11, Go)<br>
  <sub>[release: `v0.0.10`](https://github.com/jmylchreest/histui/releases/latest) · [issues: 0](https://github.com/jmylchreest/histui/issues) · [PRs: 1](https://github.com/jmylchreest/histui/pulls)</sub>
...
- **[kagimcp-zed](https://github.com/jmylchreest/kagimcp-zed)** (★5, Rust)<br>
