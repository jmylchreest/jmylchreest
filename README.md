...
- **[aide](https://github.com/jmylchreest/aide)** (★9, Go)<br>
  <sub>[release: `v0.1.1`](https://github.com/jmylchreest/aide/releases/latest) · [downloads: 3 / 788](https://github.com/jmylchreest/aide/releases) · [issues: 1](https://github.com/jmylchreest/aide/issues) · [PRs: 0](https://github.com/jmylchreest/aide/pulls)</sub>
...
- **[rosec](https://github.com/jmylchreest/rosec)** (★25, Rust)<br>
  <sub>[release: `v0.0.29`](https://github.com/jmylchreest/rosec/releases/latest) · [downloads: 4 / 205](https://github.com/jmylchreest/rosec/releases) · [issues: 6](https://github.com/jmylchreest/rosec/issues) · [PRs: 0](https://github.com/jmylchreest/rosec/pulls)</sub>
...
- **[refind-btrfs-snapshots](https://github.com/jmylchreest/refind-btrfs-snapshots)** (★23, Go)<br>
  <sub>[release: `v0.0.11`](https://github.com/jmylchreest/refind-btrfs-snapshots/releases/latest) · [downloads: 27 / 1k](https://github.com/jmylchreest/refind-btrfs-snapshots/releases) · [issues: 0](https://github.com/jmylchreest/refind-btrfs-snapshots/issues) · [PRs: 0](https://github.com/jmylchreest/refind-btrfs-snapshots/pulls)</sub>
...
- **[tinct](https://github.com/jmylchreest/tinct)** (★16, Go)<br>
  <sub>[release: `v0.3.3`](https://github.com/jmylchreest/tinct/releases/latest) · [downloads: 326 / 166k](https://github.com/jmylchreest/tinct/releases) · [issues: 0](https://github.com/jmylchreest/tinct/issues) · [PRs: 0](https://github.com/jmylchreest/tinct/pulls)</sub>
