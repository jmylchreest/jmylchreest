...
- **[rosec](https://github.com/jmylchreest/rosec)** (★28, Rust)<br>
  <sub>[release: `v0.0.30`](https://github.com/jmylchreest/rosec/releases/latest) · [downloads: 76 / 307](https://github.com/jmylchreest/rosec/releases) · [issues: 6](https://github.com/jmylchreest/rosec/issues) · [PRs: 1](https://github.com/jmylchreest/rosec/pulls)</sub>
...
- **[refind-btrfs-snapshots](https://github.com/jmylchreest/refind-btrfs-snapshots)** (★23, Go)<br>
  <sub>[release: `v0.1.1`](https://github.com/jmylchreest/refind-btrfs-snapshots/releases/latest) · [downloads: 20 / 1.2k](https://github.com/jmylchreest/refind-btrfs-snapshots/releases) · [issues: 0](https://github.com/jmylchreest/refind-btrfs-snapshots/issues) · [PRs: 0](https://github.com/jmylchreest/refind-btrfs-snapshots/pulls)</sub>
...
- **[tinct](https://github.com/jmylchreest/tinct)** (★18, Go)<br>
  <sub>[release: `v0.4.0`](https://github.com/jmylchreest/tinct/releases/latest) · [downloads: 1.2k / 256.2k](https://github.com/jmylchreest/tinct/releases) · [issues: 0](https://github.com/jmylchreest/tinct/issues) · [PRs: 0](https://github.com/jmylchreest/tinct/pulls)</sub>
...
- **[histui](https://github.com/jmylchreest/histui)** (★16, Go)<br>
  <sub>[release: `v0.0.12`](https://github.com/jmylchreest/histui/releases/latest) · [downloads: 16 / 499](https://github.com/jmylchreest/histui/releases) · [issues: 0](https://github.com/jmylchreest/histui/issues) · [PRs: 0](https://github.com/jmylchreest/histui/pulls)</sub>
...
- **[keylightd](https://github.com/jmylchreest/keylightd)** (★13, Go)<br>
  <sub>[release: `v0.1.6`](https://github.com/jmylchreest/keylightd/releases/latest) · [downloads: 40 / 626](https://github.com/jmylchreest/keylightd/releases) · [issues: 2](https://github.com/jmylchreest/keylightd/issues) · [PRs: 4](https://github.com/jmylchreest/keylightd/pulls)</sub>
...
- **[tvarr](https://github.com/jmylchreest/tvarr)** (★12, Go)<br>
  <sub>[release: `v0.0.26`](https://github.com/jmylchreest/tvarr/releases/latest) · [downloads: 1 / 35](https://github.com/jmylchreest/tvarr/releases) · [issues: 0](https://github.com/jmylchreest/tvarr/issues) · [PRs: 4](https://github.com/jmylchreest/tvarr/pulls)</sub>
